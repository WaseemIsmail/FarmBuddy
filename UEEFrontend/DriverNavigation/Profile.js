    ...
    <SafeAreaView style={{ flex: 1, backgroundColor: "#F1FEE4"}}>
      ...
      >
        <Image
              ...
              resizeMode="cover"
            />
        <Text style={{ color: "#333", fontSize: 16 , fontWeight: "bold", left:100, top:-20}}>Fresh Carrot</Text>
        <Text style={{ color: "#333", fontSize: 16 ,left:100, top:-20}}>Category : root</Text>
        <Text style={{ color: "#333", fontSize: 16 , fontWeight: "bold", left:100, top:-10}}>2 Kg</Text>
        <Text style={{ color: "#333", fontSize: 16 , fontWeight: "bold", left:220, top:-30, color:"#025F40"}}>Rs.900.00</Text>
      </View>
