...
axios.patch(`${process.env.API_URL}api/order/${order._id}`, {
  status: "Ongoing",
})
      .then((response) => {
        ...
        navigation.navigate("Ongoing", { orderId: order._id });
      })
      .catch((error) => {
        console.error("Error accepting order:", error.response.data.error);
        console.log("Request URL:", `${process.env.API_URL}api/order/${order._id}`);
    ...
    <View key={order.orderId}>
      ...
      >
        ...
        >
          ...
          <TouchableOpacity  
          //  navigation.navigate("Ongoing", { orderDetails: order._id });
